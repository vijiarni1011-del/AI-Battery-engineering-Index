...
<div class="ico-banner" style="margin-bottom:12px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">
  🔗 Auto-linked from Cell Inputs &amp; Project Targets · Current config: 
  <b style="color:var(--teal)">${S.config_label||'not set'}</b>
...
<div class="card">
  <div class="ch3">🔬 Cell Parameters <span style="font-size:9px;font-family:var(--mono);color:var(--teal)">← auto from Cell Inputs (editable override)</span></div>
